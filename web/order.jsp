<%-- 
    Document   : order
    Created on : 22 Mar, 2021, 9:21:33 PM
    Author     : Satwik
--%>
...
<html>
    ...
    <body>
        <div class="container" style="margin: 50px 70px 70px 50px;float:left;">
            <p><img src="shoes2.webp" width="200" height="200"/></p>
        ...
        <div class="container" style="margin: 50px 100px 70px 50px;float:left;">
            <p><img src="watch2.jpg" width="200" height="300"/></p>
        ...
        <div class="container" style="margin: 50px 150px 70px 50px;float:left;">
            <p> <img src="shirt2.webp" width="200" height="300"/></p>
        ...
        <div class="container" style="margin: 50px 150px 70px 50px;float:left;">
            <p> <img src="rucksack2.jpg" width="200" height="350"/></p>
