<%-- 
    Document   : index
    Created on : 23 Mar, 2021, 10:43:01 AM
    Author     : Satwik
--%>
...
<!--        <div class="container">
            ...
            <div class="myfooter">
                <h3 style="font-weight:normal; padding-left:10px">&copy;This Sample Project is Designed and Developed by Satwik Dash</h3>
            </div>
        </div>-->
        <% response.sendRedirect("loginval"); %>
    </body>
</html>